...
export default function Page() {
  return (
    ...
    <div  className='m-5 p-4 text-justify text-gray-300'>
      <div className='text-xl bg-navy-200 text-gray font-bold'> About </div>
      <br />
      ...
      <br /> 
      This web app is designed to help students with this calibration process, by providing a simple, straightforward platform where the science images and raw data can be uploaded, and using astropy scripts, the final image is generated. 
      <br />
      <br />
